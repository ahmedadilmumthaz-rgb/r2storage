...
| **Testing** | Backend smoke suite (**146 checks** — S3, multipart, copy, batch delete, object metadata, presigned, ranges/conditionals, conditional writes, auth, rate limits) and a full-platform E2E smoke (`18 checks`), both runnable in CI. |
...
npm test                  # backend smoke suite (146 checks, boots a throwaway instance)
